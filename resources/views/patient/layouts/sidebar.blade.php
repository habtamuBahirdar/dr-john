{{-- filepath: d:\My comany\dr-yohannes online schedule\dr-john\resources\views\patient\layouts\sidebar.blade.php --}}
<div id="patientSidebar" class="fixed top-0 left-0 h-full w-64 bg-blue-600 text-white p-4 space-y-4 z-50 transform transition-transform duration-300 md:translate-x-0 -translate-x-full">
    ...
    <nav class="space-y-3">
        <a href="{{ route('patient.index') }}" class="block hover:bg-blue-500 px-4 py-2 rounded">Dashboard</a>
        <a href="{{ route('appointments.index') }}" class="block hover:bg-blue-500 px-4 py-2 rounded">My Appointments</a>
        <a href="{{ route('appointments.create') }}" class="block hover:bg-blue-500 px-4 py-2 rounded">Schedule Visit</a>
